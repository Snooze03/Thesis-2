    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_weight', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='Current Weight')),
                ('goal_weight', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='Goal Weight')),
